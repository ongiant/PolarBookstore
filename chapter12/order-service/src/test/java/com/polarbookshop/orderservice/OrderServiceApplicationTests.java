...
class OrderServiceApplicationTests {
    ...
    // see: https://github.com/dasniko/testcontainers-keycloak?tab=readme-ov-file#custom-image
    @Container
    ...
    private record KeycloakToken(
        ...
        @JsonCreator
        private KeycloakToken(@JsonProperty(value = "access_token") final String accessToken) {
